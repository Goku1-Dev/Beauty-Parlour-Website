      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div ref={titleRef} className="text-center mb-8 sm:mb-12 lg:mb-16">
          <a
            ...
            className="inline-flex items-center gap-2 sm:gap-3 group cursor-hover"
          >
            <Instagram size={20} className="sm:w-6 sm:h-6 text-brand-text" />
            <h2 className="font-oswald font-light text-2xl sm:text-3xl lg:text-4xl text-brand-text group-hover:text-brand-dark-gray transition-colors">
              {instagramGalleryConfig.handle}
            </h2>
            <ExternalLink size={14} className="sm:w-4 sm:h-4 text-brand-dark-gray opacity-0 group-hover:opacity-100 transition-opacity" />
          </a>
        ...
        <div>
          <div
            ref={gridRef}
            className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-1.5 sm:gap-2 lg:gap-3"
          >
              ...
              >
                ...
                >
                  <div className="text-center">
                    <Instagram size={20} className="sm:w-6 sm:h-6 text-white mx-auto mb-1 sm:mb-2" />
                    <p className="font-roboto text-xs sm:text-sm text-white">
        ...
        <div className="mt-8 sm:mt-12 text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 sm:py-4 border border-brand-text text-brand-text hover:bg-brand-text hover:text-brand-linen transition-all duration-300 cursor-hover group"
          >
